...
_The structure returned by this API is quite complex and large. Please see [here]([https://spider.infinitybots.gg/docs#tag--Users](https://spider.infinitybots.gg/docs#get-/users/-id-) for a **much** more accurate documentation on User-related endpoints and a full list of all keys available for this endpoint_
