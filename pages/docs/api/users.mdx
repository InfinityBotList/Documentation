...
_The structure returned by this API is quite complex, large and always expanding. Please see [here](https://spider.infinitybots.gg/docs#get-/users/-id-) for a **much** more accurate documentation on all keys sent by this endpoint_
